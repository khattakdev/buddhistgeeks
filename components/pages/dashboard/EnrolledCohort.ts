    ...
    h(Box, { gap: 8 }, [
      ...
      h(
        ...
        h(
          ...
          h("h2", props.cohort.courses.name)
        )
      ),
      //cohort number
      h(Box, { h: true, gap: 16, style: { alignItems: "center" } }, [
        ...
        props.facilitating
          ...
          : null,
        !props.cohort.live
          ? h(Pill, { red: true, borderOnly: true }, "draft")
          : null,
      ]),
    ]),
    !first_event
      ...
      : h(Container, [
          ...
          props.cohort.courses.type === "course"
            ...
            : h(
                IconsImage,
                {},
                props.cohort.courses.card_image.split(",").map((src) => {
                  return h("img", {
                    src,
                    style: { height: "72px", imageRendering: "pixelated" },
                  });
                })
              ),
          ...
          !first_event
            ...
            : h(FirstEvent, [
                ...
                h(
                  Box,
                  { h: true, style: { gridAutoColumns: "min-content auto" } },
                  [
                    h("div", [
                      h(
                        "div",
                    ...
                    h(
                      ...
                      {
                        gap: 4,
                        style: { paddingTop: 4, alignContent: "space-between" },
                      },
                      [
                        h("div", [
                          h(
                            "b.textSecondary",
                            new Date(first_event.start_date)
                              .toLocaleDateString([], { weekday: "long" })
                              .toUpperCase() +
                              ` | ` +
                              getTimeBetween(
                                new Date(first_event.start_date),
                                new Date(first_event.end_date)
                              ) +
                              "hrs"
                          ),
                          h(
          ...
          h(Box, [
            ...
            h(
              ...
              h(
                "a",
                {
                  style: { color: colors.textSecondary, justifySelf: "right" },
                },
                `See all events`
              )
            ),
