      ...
      props.isFacilitator
        ...
        : h(Info, [
            ...
            h(
              "a",
              {
                href: `https://forum.hyperlink.academy/new-message?groupname=${props.cohort.courses.slug}-m`,
                target: `_blank`,
              },
            ...
            h(Box, { gap: 16 }, [
              h(CheckBox, [
                ...
                h("span", [
                  ...
                  h(
                    Link,
                    {
                      href: `http://hyperlink.academy/courses/${props.cohort.courses.slug}/${props.cohort.courses.id}/cohorts/${props.cohort.id}/templates?template=Artifact`,
                    },
                    "Artifact template"
                  ),
              ...
              h(CheckBox, [
                ...
                h("span", [
                  ...
                  h(
                    Link,
                    {
                      href: `http://hyperlink.academy/courses/${props.cohort.courses.slug}/${props.cohort.courses.id}/cohorts/${props.cohort.id}/templates?template=Retro`,
                    },
              ...
              h("span", [
                ...
                h(
                  Link,
                  {
                    href: `https://hyperlink.academy/manual/facilitators#facilitating-a-cohort`,
                  },
                  "facilitator guide"
                ),
                ".",
                ...
                items: [
                  ...
                  h("span", [
                    ...
                    h(
                      Link,
                      {
                        href: `https://hyperlink.academy/dashboard?tab=Profile`,
                      },
                      "your bio"
                    ),
