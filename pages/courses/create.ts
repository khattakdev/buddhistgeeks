...
const CreateCourse = () => {
  ...
  let [status, callCreateCourse] = useApi<
    CreateCourseMsg,
    ...
    h(FormBox, { onSubmit }, [
      ...
      h(LabelBox, { gap: 8 }, [
        ...
        h(Textarea, {
          ...
          onChange: (e) =>
            setFormData({ ...formData, prerequisites: e.currentTarget.value }),
        }),
      ]),
      h(LabelBox, { gap: 8 }, [
        h("h4", "Cost (USD)"),
        h(Input, {
          ...
          value: formData.cost,
          onChange: (e) =>
            setFormData({ ...formData, cost: parseInt(e.currentTarget.value) }),
        }),
      ]),
      h(LabelBox, { gap: 8 }, [
        h("h4", "Maintainers"),
        h(Input, {
          ...
          onChange: (e) =>
            setFormData({
              ...formData,
              maintainers: e.currentTarget.value
                .split(",")
                .map((x) => x.trim()),
            }),
        }),
