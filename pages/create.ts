...
return h(CreatorLandingWrapper, [
	...
	h(SectionContent, [
		h(LandingContainer, [
			h(Box, {gap:32}, [
				h(Title , ["Create incredible learning experiences with ", h('span', {style:{color:'blue'}}, "Hyperlink"), "."]),
				h(Box, {gap:16}, [
					h(Tagline, [`Hyperlink is for active, transformative learning, with `, h('em', `people`), ` front and center.`]),
					h(Tagline, [`We give you tools to shape great learning experiences, and do so in a financially sustainable way.`]),
				]),
				h(Box, {gap:16}, [
					h('a', {href:'/forms/propose-course'}, h(Primary, {}, `Propose a Course`)),
					h('a', {href:'/forms/propose-club'}, h(Secondary, {}, `Propose a Club`)),	
				]),
			]),
		]),
	]),
	...
	h(SectionContent, [
		h(Box, {gap:32, style:{marginTop:'-4rem'}}, [
			h(Box, {gap:16, style:{maxWidth:720, textAlign:'center', margin:'auto auto'}}, [
				h('h2', "Courses and Clubs."),
				h('p.big', `We have two formates for learning. Both are built for serious learning, convening online peer groups to explore niche topics together, led by a facilitator.`),
				h('p.big', [`What kind of learning do you want to build?`]),
			]),
			h(CourseClubSummary, [
				h(Box, {gap:16, style:{textAlign:'center'}}, [
					h('img', {src:'/img/creatorLanding/courses.png', style:{marginLeft:'auto', marginRight:'auto'}}),
				...
				h(Separator),
				h(Box, {gap:16, style:{textAlign:'center'}}, [
					h('img', {src:'/img/creatorLanding/clubs.png', style:{marginLeft:'auto', marginRight:'auto'}}),
				...
				h(Box, {gap:64}, [
					h(Box, [					
						h(Box, {gap:16, style:{maxWidth:720}}, [
							...
							h ('p.big', `Hyperlink Courses aren't limited to a particular subject or structure. We support many kinds of interesting learning experiences, and encourage experimentation. Great courses tend to:`),
						]),
						h(FourColumn, [
							h(Box, {gap:8}, [
					...
					h(Box, {gap:32, style:{maxWidth:720}}, [
						...
						h(CreatingACourseContent, [
							...
							h(Box, {gap:8, style:{width:'100%'}}, [
								...
								h('p', [
									...
									h('a', {href: "/forms/propose-course"}, `send us your proposal`), 
									`.`
								]),
							]),
						]),
						h(CreatingACourseContent, [
							...
							h(Box, {gap:8, style:{width:'100%'}}, [
								...
								h('p', [
									"Join us to develop your idea in the ", h('a', {href: "/courses/the-meta-course/1"}, `Meta Course`), ", where you'll design a curriculum and get early feedback in a community of course creators."
								]),
							]),
						]),
						h(CreatingACourseContent, [
							...
							h(Box, {gap:8, style:{width:'100%'}}, [
								...
								h('p', `Run through your curriculum with your first cohort. It won't be perfect but it'll be fun, and next time it'll be even better.`)
							]),
						]),
						h(CreatingACourseContent, [
							...
							h(Box, {gap:8, style:{width:'100%'}}, [
								...
								h('p', `Use the Hyperlink course builder to publish your course, complete with curriculum, schedule, templates, and other details.`)
							]),
						]),
						h(CreatingACourseContent, [
							...
							h(Box, {gap:8, style:{width:'100%'}}, [
								...
								h('p', `Fine tune your curriculum, run another cohort, learn more, and continue iterating. Wash, rinse, repeat.`)
							]),
						]),
					]),
				]),
	...
	h(SectionContent, [
		h(Box, {gap:64}, [
			h(Box, [
				h(Box, {gap:16, style:{maxWidth:720}}, [
					h('h2', {id: 'clubs'}, "Clubs"),
					h ('p.big', `Hyperlink Clubs are a way to engage in fun, loosely organized learning. They're easier to start, lower time commitment for facilitators, and lower cost for learners. Great clubs tend to:`),
				]),
				h(ThreeColumn, [
					h(Box, {gap:8}, [
						h('h4', "Nurture a Niche"),
					...
					h(Box, {gap:8}, [
						...
						h('p', "You facilitate, but everyone co-creates the learning experience together"),
					]),
				]),
			]),
			h(Box, {gap:32, style:{maxWidth:720}}, [
				...
				h(CreatingACourseContent, [
					...
					h(Box, {gap:8, style:{width:'100%'}}, [
						...
						h('p', [
							...
							h('a', {href: "/forms/propose-club"}, `send us your proposal`), 
				...
				h(CreatingACourseContent, [
					...
					h(Box, {gap:8, style:{width:'100%'}}, [
						...
						h('p', `We'll make you a draft club; you'll edit the details and schedule, then publish your club to the site.`)
					]),
				]),
				h(CreatingACourseContent, [
					...
					h(Box, {gap:8, style:{width:'100%'}}, [
						h('h4', "Run Your Club"),
						h('p', `Convene a group of learners and get started exploring together!`)
					]),
				]),
				h(CreatingACourseContent, [
					...
					h(Box, {gap:8, style:{width:'100%'}}, [
						h('h4', "…And Again?"),
						h('p', `You can run your club once, or do it again with a new group, as many times as you like.`)
					]),
				]),
			]),
		]),
				...
				h(Box, {gap:32}, [
					...
					h(FeatureGrid, [
						h(Feature, [
							...
							h('p.textSecondary', "Draft your curriculum, set a price, add events, build your course structure — we'll help you get everything set up!"),
						]),
						h(Feature, [
						...
						h(Feature, [
							...
							h('p.textSecondary', "Set participant limits, invite-only courses, create discounts to offer scholarships and more"),
						]),
						h(Feature, [
							h('h4', "Events and Calendar"),
							h('p.textSecondary', "Create and view course events; subscribe to a calendar with all your Hyperlink events"),
						]),
						h(Feature, [
							h('h4', "Hyperlink Community"),
							h('p.textSecondary', "Meta Course, events, workshops — join a community of like-minded teachers and learners"),
						]),
						h(Feature, [
							h('h4', "Let's Experiment Together!"),
							h('p.textSecondary', "We're continually learning; you can impact the shape of this community and what we build"),
						]),
					]),
				]),
			]),
			...
			h(SectionContent, [
				h(Box, {gap:32}, [
					h(Box, {gap:16, style:{maxWidth:720}}, [
						...
						h('ul', [
							h('li', [h('p.big', "You set the price for your course or club (we're happy to advise)")]),
							h('li', [h('p.big', "Hyperlink takes a 20% platform fee, including payment processing")]),
							h('li', [h('p.big', "You keep 80% of tuition, paid out via Stripe at the end of each cohort")]),
						]),
						h('img', {src:'/img/creatorLanding/pricingDiagram.png', style:{width:'100%', maxWidth:640}}),
					]),
				]),
			]),
		]),
