...
- **Learn in the open:** As much as possible, a course's curriculum and output should be openly shared. Hyperlink strongly supports open source (see our [code base here](https://gitlab.com/hyperlink-academy/app)!) and we're interested in extending this ethos to the learning process. Learners should retain full control over things they create, and it's up to a course to determine how its artifacts are shared; this isn't a rule but an aspiration for courses and their participants.
