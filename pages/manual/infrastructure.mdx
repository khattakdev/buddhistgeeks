...
The Hyperlink platform itself is open source software. You can [view the source code](https://gitlab.com/hyperlink-academy/app) and submit changes if you find a bug!
