...
let COPY = {
  hyperlinkTagline:
    "Buddhist Geeks Training is a gateway to all of the resources & opportunities offered in the Buddhist Geeks Ecosystem of Practice.",
  registerHeader:
    "Calling all superlearners! Join the Hyperlink Alpha to propose a course idea, and (very soon!) enroll one of our first courses.",
...
const Welcome = () => {
  return h(LandingContainer, [
    h(Box, { gap: 16 }, [
      h(Box, { gap: 32 }, [
        h(Title, ["buddhistgeeks.", h("wbr"), "academy"]),
